...
import static Parte1.UIpart1.Mejercicio19;
import java.awt.Color; 
import javax.swing.JOptionPane;
import java.awt.event.KeyEvent;
import java.text.DecimalFormat;
import zCodeEjercicios.exercise19;
...
public class ejercicio19 extends javax.swing.JFrame  {
    ...
    private void lbl_exitMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_exitMouseClicked
        Mejercicio19 = false;   // regresa el valor a false para poder volver a abrir la ventana
    ...
    private void lbl_calcularMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_calcularMouseClicked
        ...
        perimetro = (exercise19.Calcular_perimetro(lado));        // a lo capturado en la variable lado
        altura = (exercise19.Calcular_altura(lado));
        area = (exercise19.Calcular_area(lado));
